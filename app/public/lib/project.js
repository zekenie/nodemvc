...
(function() {
  ...
  template = '<div id="header"> <button data-grab="addEntityBtn" class=" btn btn-success">Add Entity</button> <button class="btn btn-warning" data-toggle="modal" data-target="#dependencies">Dependencies</button> <button data-grab="downloadBtn" class=" btn btn-danger">Download</button> <ul data-grab="pills" class="nav pull-right nav-pills"></ul> </div> <div class="modal fade" id="dependencies"> <div class="modal-dialog"> <div class="modal-content"> <div class="modal-header"> <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> <h4 class="modal-title">Dependencies</h4> </div> <div class="modal-body" data-grab="dependencyContainer"> <input type="text" autofocus placeholder="Search bower/npm..." class="typeahead form-control" data-grab="typeahead"> <br/><br/> <i>One per line</i> <br/><br/> <div class="row"> <div class="col-sm-6"> <p>NPM</p> <textarea rv-value="npm | lineToArray" class="form-control"></textarea> </div> <div class="col-sm-6"> <p>Bower</p> <textarea rv-value="bower | lineToArray" class="form-control"></textarea> </div> </div> </div> <div class="modal-footer"> <button type="button" class="btn btn-default" data-dismiss="modal">Close</button> </div> </div> </div> </div> <div class="tab-content"> </div>';
