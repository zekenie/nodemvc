...
(function() {
  ...
  template = '<tr class="property"> <td><button data-grab="arrayBtn" type="button" class="btn btn-default btn-sm" data-toggle="button">[ ]</button></td> <td><input autofocus class="form-control" type="text" size="6" placeholder="key" rv-input="key | codeSafe"></td> <td> <select data-grab="typeSelect" rv-value="type" class="form-control"> <option></option> </select> </td> <td> <select data-grab="refSelect" rv-value="ref" class="hide form-control"> <option></option> </select> </td> <td class="delete" width="9%"><button data-grab="deleteBtn" class="btn btn-sm btn-danger"><span class="glyphicon glyphicon-remove"></span></button></td> </tr>';
